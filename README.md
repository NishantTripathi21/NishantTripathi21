...
- **DSA in C++** — consistent problem solving on LeetCode & Codeforces
- **Cloud & DevOps** — Docker, CI/CD pipelines, Linux
- **Generative AI** — RAG pipelines, embeddings, LLM integrations
- **Core CS** — OS, DBMS, OOP
